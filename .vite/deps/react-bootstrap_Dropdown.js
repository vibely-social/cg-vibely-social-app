...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react13.default).createContext($704cf1d3b684cc5c$var$defaultContext);
...
function $704cf1d3b684cc5c$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react13.useContext)($704cf1d3b684cc5c$var$SSRContext);
...
function $704cf1d3b684cc5c$var$useModernSSRSafeId(defaultId) {
  ...
  let [didSSR] = (0, import_react13.useState)($704cf1d3b684cc5c$export$535bd6ca7f90a273());
  let prefix = didSSR ? "react-aria" : `react-aria${$704cf1d3b684cc5c$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $704cf1d3b684cc5c$export$619500959fc48b26 = typeof (0, import_react13.default)["useId"] === "function" ? $704cf1d3b684cc5c$var$useModernSSRSafeId : $704cf1d3b684cc5c$var$useLegacySSRSafeId;
...
function $704cf1d3b684cc5c$export$535bd6ca7f90a273() {
  if (typeof (0, import_react13.default)["useSyncExternalStore"] === "function")
    return (0, import_react13.default)["useSyncExternalStore"]($704cf1d3b684cc5c$var$subscribe, $704cf1d3b684cc5c$var$getSnapshot, $704cf1d3b684cc5c$var$getServerSnapshot);
  let cur = (0, import_react13.useContext)($704cf1d3b684cc5c$var$SSRContext);
  return cur.isSSR;
}
...
function useBootstrapPrefix(prefix, defaultPrefix) {
  const {
    prefixes
  } = (0, import_react27.useContext)(ThemeContext);
...
var DropdownItem2 = React13.forwardRef(({
  bsPrefix,
  className,
  eventKey,
  disabled = false,
...
var context2 = React15.createContext(null);
...
var DropdownMenu2 = React16.forwardRef(({
  bsPrefix,
  className,
  align,
  rootCloseEvent,
...
var DropdownToggle2 = React18.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
...
var Dropdown2 = React20.forwardRef((pProps, ref) => {
  ...
  return (0, import_jsx_runtime15.jsx)(DropdownContext_default2.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime15.jsx)(Dropdown_default, {
      placement,
      show,
      onSelect,
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime15.jsx)(Component, {
        ...props,
        ref,
        className: (0, import_classnames6.default)(className, show && "show", directionClasses[drop])
      })
    })
  });
});
