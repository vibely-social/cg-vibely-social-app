                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      backgroundImage:
                        "url('https://media.discordapp.net/attachments/646934670679998474/1127544766817644594/keyboard.png?width=1006&height=662')",
                    }}
                  ></div>
                </a>
              </div>
            ...
            >
              ...
              <div className="card-body p-0 d-flex">
                <ul className="d-flex align-items-center justify-content-between mt-2">
                  ...
                  <li className="me-1">
                    <a href="#" className="btn-round-lg bg-twitter">
