    ...
    return ( <Col xl={4} xxl={3} lg={4}>
              ...
              <div className="card w-100 shadow-xss rounded-xxl border-0 p-0 ">
                ...
                <div className="card-body bg-transparent-card d-flex p-3 bg-greylight ms-3 me-3 rounded-3">
                  <figure className="avatar me-2 mb-0"><img src="https://via.placeholder.com/50x50.png" alt="image" className="shadow-sm rounded-circle w45" /></figure>
                ...
                <div className="card-body bg-transparent-card d-flex p-3 bg-greylight m-3 rounded-3" style={{marginBottom: '0 !important'}}>
                  <figure className="avatar me-2 mb-0"><img src="https://via.placeholder.com/50x50.png" alt="image" className="shadow-sm rounded-circle w45" /></figure>
                  <h4 className="fw-700 text-grey-900 font-xssss mt-2"> David Agfree  <span className="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">12 mutual friends</span></h4>
                  <a href="#" className="btn-round-sm bg-white text-grey-900 feather-plus font-xss ms-auto mt-2" />
                </div>
                <div className="card-body bg-transparent-card d-flex p-3 bg-greylight m-3 rounded-3">
                  <figure className="avatar me-2 mb-0"><img src="https://via.placeholder.com/50x50.png" alt="image" className="shadow-sm rounded-circle w45" /></figure>
                  <h4 className="fw-700 text-grey-900 font-xssss mt-2">Hugury Daugloi <span className="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">12 mutual friends</span></h4>
                  <a href="#" className="btn-round-sm bg-white text-grey-900 feather-plus font-xss ms-auto mt-2" />
                </div>
              </div>
              <div className="card w-100 shadow-xss rounded-xxl border-0 mb-3 mt-3">
                ...
                <div className="card-body d-flex pt-4 ps-4 pe-4 pb-0 overflow-hidden border-top-xs bor-0">
                  <img src="https://via.placeholder.com/400x300.png" alt="img" className="img-fluid rounded-xxl mb-2" />
                </div>
                <div className="card-body dd-block pt-0 ps-4 pe-4 pb-4">
                  <ul className="memberlist mt-1 mb-2 ms-0 d-block">
                    <li className="w20"><a href="#"><img src="https://via.placeholder.com/50x50.png" alt="user" className="w35 d-inline-block" style={{opacity: 1}} /></a></li>
                    <li className="w20"><a href="#"><img src="https://via.placeholder.com/50x50.png" alt="user" className="w35 d-inline-block" style={{opacity: 1}} /></a></li>
                    <li className="w20"><a href="#"><img src="https://via.placeholder.com/50x50.png" alt="user" className="w35 d-inline-block" style={{opacity: 1}} /></a></li>
                    <li className="w20"><a href="#"><img src="https://via.placeholder.com/50x50.png" alt="user" className="w35 d-inline-block" style={{opacity: 1}} /></a></li>
                    <li className="last-member"><a href="#" className="bg-greylight fw-600 text-grey-500 font-xssss w35 ls-3 text-center" style={{height: 35, lineHeight: 35}}>+2</a></li>
              ...
              <div className="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                ...
                <div className="card-body d-flex align-items-center pt-0 ps-4 pe-4 pb-4">
                  <a href="#" className="p-2 lh-28 w-100 bg-grey text-grey-800 text-center font-xssss fw-700 rounded-xl"><i className="feather-external-link font-xss me-2" /> Like Page</a>
                </div>
                <div className="card-body d-flex pt-0 ps-4 pe-4 pb-0 overflow-hidden">
                  <img src="https://via.placeholder.com/400x300.png" alt="img" className="img-fluid rounded-xxl mb-2 bg-lightblue" />
                </div>
                <div className="card-body d-flex align-items-center pt-0 ps-4 pe-4 pb-4">
                  <a href="#" className="p-2 lh-28 w-100 bg-grey text-grey-800 text-center font-xssss fw-700 rounded-xl"><i className="feather-external-link font-xss me-2" /> Like Page</a>
                </div>
