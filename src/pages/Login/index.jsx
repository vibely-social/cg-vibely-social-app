        ...
        <div className="main-wrap">
            <div className="nav-header bg-transparent shadow-none border-0">
                <div className="nav-top w-100">
                    ...
                    <span
                        className="header-btn d-none opacity-30 d-lg-block bg-dark fw-500 text-white font-xsss p-3 ms-auto w100 text-center lh-20 rounded-xl">
                            Login
                        </span>
                    <Link to="/register"
                            ...
                            <Form className="infoform" onSubmit={formik.handleSubmit}>
                                ...
                                <div className="form-check text-left mb-3">
                                    <input type="checkbox" className="form-check-input mt-2"
                                           id="exampleCheck1"/>
                                    <label className="form-check-label font-xsss text-grey-500 cursor-pointer"
