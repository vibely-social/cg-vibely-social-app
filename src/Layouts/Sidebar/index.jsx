...
function Sidebar() {
    ...
    const [maxIconWidth,setMaxIconWidth] = useState(50);
    ...
    <motion.nav style={!isMobile ? {overflow: "visible",left: '-200px'} : {}} 
            ...
            <Container className="ps-0 pe-">
                <div  className="nav-content">
                    <div  className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                        <ListGroup  as="ul" className="mb-1 p-0 top-content ">
                            {SidebarData.map((item,index) => {
                            return <ListGroup.Item as="li" 
                            style={{border: 'none', padding:'0',filter: "hue-rotate(338deg)"}}  
                            key={index} >
                                <Link 
