...
function FanPageIntro() {
    ...
    return (<>
        <div className="card w-100 shadow-xss rounded-xxl border-0">
            ...
            <div className="card-body ms-1 pb-0 pt-0">
                <h4 className="d-flex align-items-center pb-2">
                    <i className="feather-info me-2"></i>
                    Trang · Trường học
                </h4>
                <h4 className="d-flex align-items-center pb-2">
                    <i className="feather-corner-up-right me-2"></i>
                    21K Nguyễn Văn Trỗi, Quận Phú Nhuận, Ho Chi Minh City, Vietnam
                </h4>
                <h4 className="d-flex align-items-center pb-2">
