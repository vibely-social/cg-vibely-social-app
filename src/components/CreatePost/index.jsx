        ...
        <Card className="w-100 shadow-xss rounded-xxl border-0 ps-2 x pe-4 pb-2 mb-3">
            <Card.Body className="p-0">
                ...
                <Card.Body className="p-0 mt-3 d-flex justify-content-center pb-2 ">
                    ...
                    <textarea onClick={() => setIsOpen(!isOpen)} style={{height: "50px",width: "90%",resize: "none"}} className="float-right ms-2 bor-0 rounded-xxl p-2 ps-3 font-xssss text-grey-500 fw-500 border-light-md " placeholder="What's on your mind?" />
                </Card.Body>
