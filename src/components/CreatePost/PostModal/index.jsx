...
import {setImages, setStatus, setPage, setHasMore} from "~/features/getMedia/index.jsx";
                    ...
                    <div className="dialog-post-wrapper">
                        <section className="post-content">
                            ...
                            <Form onSubmit={handleSubmit}>
                                ...
                                <Form.Group className="options">
                                    ...
                                    <ListGroup as="ul" className="list-items-post">
                                        <ListGroup.Item
                                            as="li"
                                            onClick={() => {
                                                if (postImage.length == 0) setIsAddImage(!isAddImage)
                                            }}>
                                            <img src={Gallery}/>
                                        </ListGroup.Item>
                                ...
                                <Button type="submit" style={{background: !allowPost && "#e4e6ebff"}}
                                        disabled={!allowPost && true}
                                        className='border-0 button-post shadow-xss mt-2'>Post</Button>
                            </Form>
                        </section>
                    </div>
                </motion.div>
