                            ...
                            <div key={index}
                                ...
                                <div className="card d-block border-0 shadow-xss rounded-3 mb-3">
                                    <div className="card-body d-block d-flex w-100">
                                        ...
                                        <Link to={`/friends/${friend.id}`} className="ms-3 cursor-pointer">
                                            <h4 className="fw-700 font-xsss mt-3 hover-underline hover-scale-1-1">
                                                {`${friend.firstName} ${friend.lastName}`}
                                            </h4>
                                            <div className="fw-500 font-xsssss text-grey-500 mt-0 mb-3">{friend.email}</div>
                                        </Link>
                                        ...
                                        <div className="dropdown-menu dropdown-menu-end p-2 rounded-xxl border-0 shadow-lg"
                                            aria-labelledby="dropdownMenu4">
                                            <Link to={`/friends/${friend.id}`} className="card-body rounded p-2 d-flex mt-2">
                                                <i className="feather-user text-grey-500 me-3 font-lg"></i>
                                                <h4 className="fw-600 text-grey-900 font-xssss mt-0 me-4">
                                                    Personal page
                                                    <span className="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">See all friend details</span>
                                                </h4>
                                            </Link>
                                            <div className="card-body p-0 d-flex mt-2 hover-vibe rounded p-2 cursor-pointer">
                                                <i className="feather-x-square text-grey-500 me-3 font-lg"></i>
                                                <h4 className="fw-600 text-grey-900 font-xssss mt-0 me-4">
                                                    Unfollow
                                                    <span className="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Stop following friend status</span>
                                                </h4>
                                            </div>
                                            <div className="card-body p-0 d-flex hover-vibe rounded p-2 mt-2 cursor-pointer">
                                                <i className="feather-user-x text-grey-500 me-3 font-lg"></i>
                                                <h4 className="fw-600 mb-0 text-grey-900 font-xssss mt-0 me-4">
                                                    Unfriend
                                                    <span className="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Remove from friend list</span>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
